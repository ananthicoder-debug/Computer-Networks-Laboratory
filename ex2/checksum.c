...
int main() {
    ...
    printf("1. Binary string\n");
    printf("2. Text characters\n");
    printf("Enter choice: ");
    scanf("%d", &input_type);
    getchar();
    ...
    printf("\n--- CHOOSE AN OPTION ---\n");
    printf("1. Send with no error\n");
    printf("2. Add 1 wrong bit\n");
    ...
    if (is_valid) {
        printf("\nResult: Data is OK! No errors found.\n");
        ...
        printf("\nResult: Data is bad! Errors found.\n");
    }
